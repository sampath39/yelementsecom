    ...
    <AppLayout>
      ...
      <div className="container mx-auto px-4 lg:px-8 py-8 max-w-6xl">
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {items.map((product) => (
              <Card key={product.id} className="bg-gradient-to-b from-white to-slate-50 border border-slate-100 rounded-3xl overflow-hidden hover:shadow-xl hover:-translate-y-1.5 active:translate-y-0 transition-all duration-300 group flex flex-col h-full justify-between">
                <div className="aspect-square relative bg-slate-50 border-b overflow-hidden">
                  ...
                  <button 
                    ...
                    className="absolute top-3 right-3 w-8 h-8 bg-white/90 backdrop-blur-sm hover:bg-rose-50 rounded-full flex items-center justify-center text-slate-500 hover:text-rose-500 shadow border transition-colors"
                    title="Remove item"
                  >
